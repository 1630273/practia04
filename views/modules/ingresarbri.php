                            ...
                            <form class="" action="POST">
                                ...
                                <div class="form-group m-b-20 row">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="text" name="usuario" required="" placeholder="Esrbibe tu suario">
                                    </div>
                                </div> 
                                ...
                                <div class="form-group row m-b-20">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="password" required="" name="password" placeholder="Escribe tu contraseña">
                                    </div>
                                </div>
